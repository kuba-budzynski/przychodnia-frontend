...
export default function Example() {
    return (
        <div className={`min-h-screen min-w-full flex flex-col justify-center mt-8 ${patterns.pattern}`}>
            <div className="relative w-11/12 xl:w-full h-full max-w-full xl:max-w-6xl xxl:max-w-screen-2xl xxxl:max-w-8xl mx-auto flex flex-col justify-center">
                ...
                <div className="relative shadow-xl rounded-3xl w-full bg-white flex flex-col xl:flex-row max-h-[80vh] h-screen xxxl:max-h-[75vh]">
                    <div className="relative w-full xl:w-1/2 h-full">
                        ...
                        <div className="w-full h-full flex flex-col justify-center justify-items-center px-6">
                            <h2 className="text-2xl xl:text-5xl font-bold text-center text-indigo-500 uppercase border-b-2 border-dashed border-indigo-200 pb-6">
                                Zaufaj doświadczeniu
                            </h2>
                            <p className="text-gray-400 mt-6 text-justify px-8 line-clamp-4 lg:line-clamp-6 xl:line-clamp-none">
                        ...
                        <div className="absolute inset-x-2 bottom-2 h-12 hidden xl:block">
                            <bottom
                                type="button"
                    ...
                    <div className="relative w-full xl:w-1/2 h-full bg-hero-landscape xl:bg-hero-image bg-no-repeat bg-cover rounded-b-3xl xl:rounded-b-none xl:rounded-r-3xl"></div>
                </div>
            </div>
        </div>
    );
