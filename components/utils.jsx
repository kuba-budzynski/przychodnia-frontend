...
export const Loader = ({color}) => <div className="w-full h-full mx-auto flex justify-center justify-items-center"><BiLoaderCircle className={`w-12 h-12 animate-spin ${color ? color : 'text-white'}`}/></div>